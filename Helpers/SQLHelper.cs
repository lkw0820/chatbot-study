...
namespace GreatWall.Helpers
{
    ...
    {
        private const string strDBServer = "Server=tcp:greatwall-db-server2.database.windows.net,1433;Initial Catalog=greatwall-db;Persist Security Info=False;User ID=lkw;Password=rldnjs11@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
